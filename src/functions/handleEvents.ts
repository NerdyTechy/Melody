...
export default (client: any) => {
    ...
    fs.readdirSync(botEventsPath).filter((file) => file.endsWith(".js") || file.endsWith(".ts")).forEach((file) => {
    ...
    fs.readdirSync(playerEventsPath).filter((file) => file.endsWith(".js") || file.endsWith(".ts")).forEach((file) => {
